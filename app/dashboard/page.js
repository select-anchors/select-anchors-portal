    ...
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="flex items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button className="border border-gray-400 rounded-xl px-4 py-2 hover:bg-gray-50">Assign Truck</button>
          <button className="bg-[#2f4f4f] text-white rounded-xl px-4 py-2 hover:opacity-90">Add to My Day</button>
        </div>
      </div>
              ...
              <tr key={i} className="border-b last:border-0">
                ...
                <td className="py-3 pr-5 text-right">
                  <span className={
                    ...
                    (r.status === 'Scheduled' ? "bg-amber-500 text-white" :
                     r.status === 'Pending'   ? "bg-gray-200 text-gray-800" :
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button className="border border-gray-400 rounded-xl px-4 py-2 hover:bg-gray-50">Export CSV</button>
        <button className="border border-gray-400 rounded-xl px-4 py-2 hover:bg-gray-50">Filter</button>
        <button className="bg-[#2f4f4f] text-white rounded-xl px-4 py-2 hover:opacity-90">New Job</button>
      </div>
    </div>
  );
}
